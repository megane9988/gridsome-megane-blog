<template>
  <div class="layout">
	<h1 class="site-logo" id="top">
		<g-link to="/">
		<svg enable-background="new 0 0 268.6 92.4" version="1.1" viewBox="0 0 268.6 92.4" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
	...
	<a class="gototop" href="#" v-scroll-to="'#top'"> ↑ </a>
  </div>
